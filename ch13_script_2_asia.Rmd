...
unique(nes$race)
```
Suppose we split the American population into five income groups ranked in order of wealth. A higher income group is 5 percent less likely to vote for the Democratic candidate compared to the group immediately below it but it might be as low as 4 or 7 percent.
